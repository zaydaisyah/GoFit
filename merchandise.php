...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'Merchandise' ORDER BY name");
    $stmt->execute();
...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="img/breadcrumb/merch-bg.png">
        <div class="container">
            <div class="row">
